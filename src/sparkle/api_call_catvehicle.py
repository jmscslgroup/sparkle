...
for i in range(4):
    datafile = animate_catvehicle( package_name="catvehicle", circumference = 230, num_vehicles=1, publish_rate=100.0, max_update_rate=100.0, time_step=0.01, log_time=30.0, include_laser=True, logdir = "/home/ivory/CyverseData/ProjectSparkle", description="CAT Vehice Simulation: Single Car")
